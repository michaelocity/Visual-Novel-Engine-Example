...
import com.highlowgame.game.gui.RicoChooser;
import com.highlowgame.game.gui.RicoGame;
import com.highlowgame.game.gui.dialouge.OutsideDialouge;
import com.highlowgame.game.math.TextAnimation;

public class Outside extends AbstractScreen {
    Texture background = new Texture("backgrounds/outside.jpg");
    OutsideDialouge dialouge = new OutsideDialouge();
    ...
    private void checkForInBounds() {
        if (dialougeIndex > dialouge.size() - 1) {
            dialougeIndex = dialouge.size() - 1;
            game.setScreen(new RicoChooser(game));
        }
    }
