...
import com.highlowgame.game.gui.dialouge.GoodEndDialouge;
import com.highlowgame.game.gui.dialouge.NeutralEndDialouge;
import com.highlowgame.game.math.TextAnimation;

public class NeutralEnd extends AbstractScreen {
    Texture background = new Texture("backgrounds/ladyLuckCasino.jpg");
    NeutralEndDialouge dialouge = new NeutralEndDialouge();
    TextAnimation animation = new TextAnimation("");


    public NeutralEnd(RicoGame game) {
        super(game);
